...
def loadWAV_trimmed(filename, max_frames, evalmode=True, num_eval=10):
    ...
    # TRIM
    audio = librosa.effects.trim(y=audio, top_db=20, frame_length=max_frames, hop_length=160)
    # audio = librosa.effects.trim(y=audio, top_db=20)
    audio = audio[0]
